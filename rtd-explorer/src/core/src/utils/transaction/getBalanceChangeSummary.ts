...
import { normalizeRtdObjectId, parseStructTag } from "rtd-typescript/utils";
...
export const getBalanceChangeSummary = (
	transaction: DryRunTransactionBlockResponse | RtdTransactionBlockResponse,
