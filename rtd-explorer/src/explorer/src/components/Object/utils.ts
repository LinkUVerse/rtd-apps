...
export function extractSerializationType(type: RtdMoveNormalizedType | ""): TypeReference {
...
function getDisplayName(type: RtdMoveNormalizedType | "", objectType: string) {
	...
	// Balance<XUS> || Balance<LSP<RTD, USDT>>
...
export function getFieldTypeValue(type: RtdMoveNormalizedType | "", objectType: string) {
