...
import { type RtdValidatorSummary } from "rtd-typescript/client";
...
type ValidatorMetaProps = {
	validatorData: RtdValidatorSummary;
};
				...
				<div className="mt-1.5 flex flex-col">
					...
					{projectUrl && (
						<a
							...
							className="mt-2.5 inline-flex items-center gap-1.5 text-body font-medium text-rtd-dark no-underline"
						>
							{projectUrl.replace(/\/$/, "")}
				...
				<DescriptionList>
					...
					<DescriptionItem title="Address" align="start">
						<div className="flex items-start gap-1">
							<AddressLink address={validatorData.rtdAddress} noTruncate />
							<CopyToClipboard size="md" color="steel" copyText={validatorData.rtdAddress} />
						</div>
					</DescriptionItem>
