...
/**
 * Converts a RtdMoveNormalizedType to string
 ...
 * T is provided on function level with the type_parameters field of RtdMoveNormalizedFunction that defines the abilities.
