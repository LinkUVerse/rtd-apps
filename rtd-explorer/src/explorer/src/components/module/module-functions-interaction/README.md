...
This web tool lets you call functions on any Rtd module, including non-entry functions. For example:
...
Rtd string arguments are typically either `0x1::string::String` or `vector<u8>`. The tool works with both:
