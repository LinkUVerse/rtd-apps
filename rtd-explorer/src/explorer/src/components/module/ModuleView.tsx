...
function unwrapTypeReference(type: RtdMoveNormalizedType): null | TypeReference {
	...
	return (
		<section className={styles.modulewrapper}>
			<div className={cl(styles.code, styles.codeview)}>
				<Highlight code={code} language="rust" theme={undefined}>
									...
									{line.map((token, key) => {
										...
										if (
											...
											<LinkWithQuery
												...
												to={href}
												target={
												normalizeRtdAddress(reference.address) === normalizeRtdAddress(id!)
													? undefined
													: "_blank"
												}
											/>
