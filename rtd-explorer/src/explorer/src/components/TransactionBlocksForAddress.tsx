...
import { type TransactionFilter } from "rtd-typescript/client";
import { Heading, RadioGroup, RadioGroupItem } from "@linku/ui";
...
function TransactionBlocksForAddress({
	...
	const { data, isPending, isFetching, isFetchingNextPage, fetchNextPage, hasNextPage } =
		useGetTransactionBlocks(
			{ [filterValue]: normalizeRtdAddress(address) } as TransactionFilter,
			undefined,
			undefined,
