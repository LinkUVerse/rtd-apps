...
export const ToS_LINK = 'https://linkuverse.com/legal#rtdwallettermsofservice';
export const PRIVACY_POLICY_LINK = 'https://linkuverse.com/legal#privacypolicy';
export const FAQ_LINK = 'https://docs.linkuverse.com/faq';
...
export const MIN_NUMBER_RTD_TO_STAKE = 1;
