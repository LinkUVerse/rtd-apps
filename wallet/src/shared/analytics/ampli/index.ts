 ...
 *
 * [View Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest)
 *
 * [Full Setup Instructions](https://data.amplitude.com/linkulabs/Rtd%20Wallet/implementation/web)
 */
...
export interface IdentifyProperties {
	...
	/**
	 * The Rtd Network that the user is currently interacting with.
	 */
...
export interface ClickedStakeRtdProperties {
	/**
	 * Whether or not the user is already staking some RTD.
	 */
...
export interface ClickedUnstakeRtdProperties {
	/**
	 * The amount of RTD staked.
	 *
	 * | Rule | Value |
	 * |---|---|
	 * | Type | number |
...
export interface StakedRtdProperties {
	/**
	 * The amount of RTD staked.
	 *
	 * | Rule | Value |
...
export interface StakedRtdFailedProperties {
	/**
	 * A message associated with an error event.
	 */
	errorMessage: string;
...
export interface UnstakedRtdProperties {
	/**
	 * The address of the selected validator.
	 */
	validatorAddress: string;
...
export class ClickedStakeRtd implements BaseEvent {
	event_type = 'clicked stake RTD';

	constructor(public event_properties: ClickedStakeRtdProperties) {
		this.event_properties = event_properties;
	}
}
...
export class ClickedUnstakeRtd implements BaseEvent {
	event_type = 'clicked unstake RTD';

	constructor(public event_properties: ClickedUnstakeRtdProperties) {
		this.event_properties = event_properties;
	}
}
...
export class StakedRtd implements BaseEvent {
	event_type = 'staked RTD';

	constructor(public event_properties: StakedRtdProperties) {
		this.event_properties = event_properties;
	}
}

export class StakedRtdFailed implements BaseEvent {
	event_type = 'staked RTD (failed)';

	constructor(public event_properties: StakedRtdFailedProperties) {
		this.event_properties = event_properties;
	}
}
...
export class UnstakedRtd implements BaseEvent {
	event_type = 'unstaked RTD';

	constructor(public event_properties: UnstakedRtdProperties) {
		this.event_properties = event_properties;
	}
}
...
export class Ampli {
  ...
  */
   ...
   * added accounts
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/added%20accounts)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/bypassed%20scam%20warning)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20bullshark%20quests%20cta)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20collectible%20card)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20create%20new%20account)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20create%20new%20wallet)
   *
   ...
   * clicked get started
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20get%20started)
   *
   ...
   * clicked hide asset
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20hide%20asset)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20import%20existing%20wallet)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20import%20passphrase)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20import%20private%20key)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20social%20sign%20in%20button)
   *
   ...
   * clicked stake RTD
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20stake%20RTD)
   *
   * When users click to stake RTD in the wallet.
   *
   * Owner: Jon Shek
   *
   ...
   */
  clickedStakeRtd(
    properties: ClickedStakeRtdProperties,
    options?: EventOptions,
  ) {
    return this.track(new ClickedStakeRtd(properties), options);
  }

  /**
   * clicked swap coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20swap%20coin)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20token%20claims%20banner)
   *
   * Event has no description in tracking plan.
   *
   ...
   * clicked unstake RTD
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20unstake%20RTD)
   *
   * When users click to unstake RTD.
   *
   * Owner: Jon Shek
   *
   ...
   */
  clickedUnstakeRtd(
    properties: ClickedUnstakeRtdProperties,
    options?: EventOptions,
  ) {
    return this.track(new ClickedUnstakeRtd(properties), options);
  }

  /**
   * clicked usdc promo banner
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/clicked%20usdc%20promo%20banner)
   *
   * Event has no description in tracking plan.
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/connected%20hardware%20wallet)
   *
   ...
   * created new wallet
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/created%20new%20wallet)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/disconnected%20application)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/imported%20existing%20account)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/interacted%20with%20malicious%20domain)
   *
   ...
   * opened application
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/opened%20application)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/opened%20connect%20ledger%20flow)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/opened%20wallet%20extension)
   *
   ...
   * pinned coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/pinned%20coin)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/received%20onramp%20providers%20data)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/Received%20onramp%20providers%20data%20(failed))
   *
   * Event to track when data from onramp providers is received
   *
   * @param properties The event's properties (e.g. countryCode)
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/responded%20to%20connection%20request)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/responded%20to%20transaction%20request)
   *
   ...
   * selected coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/selected%20coin)
   *
   ...
   * selected validator
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/selected%20validator)
   *
   ...
   * sent coin failed
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/sent%20coin%20failed)
   *
   ...
   * sent coins
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/sent%20coins)
   *
   ...
   * sent collectible
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/sent%20collectible)
   *
   * Owner: William Robertson
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/sent%20collectible%20(failed))
   *
   * Event has no description in tracking plan.
   *
   * @param properties The event's properties (e.g. errorMessage)
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/signed%20transaction%20block%20failed)
   *
   ...
   * staked RTD
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/staked%20RTD)
   *
   * When users successfully stake RTD with a validator.
   *
   * Owner: Jon Shek
   *
   * @param properties The event's properties (e.g. stakedAmount)
   ...
   */
  stakedRtd(
    properties: StakedRtdProperties,
    options?: EventOptions,
  ) {
    return this.track(new StakedRtd(properties), options);
  }

  /**
   * staked RTD (failed)
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/staked%20RTD%20(failed))
   *
   * Event fired when a user attempt to native stake RTD results in a failure.
   *
   * @param properties The event's properties (e.g. errorMessage)
   * @param options Amplitude event options.
   */
  stakedRtdFailed(
    properties: StakedRtdFailedProperties,
    options?: EventOptions,
  ) {
    return this.track(new StakedRtdFailed(properties), options);
  }

  /**
   * swapped coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/swapped%20coin)
   *
   ...
   * swapped coin (failed)
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/swapped%20coin%20(failed))
   *
   * Event has no description in tracking plan.
   *
   * @param properties The event's properties (e.g. errorMessage)
   ...
   * switched account
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/switched%20account)
   *
   ...
   * switched network
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/switched%20network)
   *
   ...
   * unpinned coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/unpinned%20coin)
   *
   ...
   * unstaked RTD
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/unstaked%20RTD)
   *
   * When users successfully un-stake RTD.
   *
   * Owner: Jon Shek
   *
   * @param properties The event's properties (e.g. validatorAddress)
   ...
   */
  unstakedRtd(
    properties: UnstakedRtdProperties,
    options?: EventOptions,
  ) {
    return this.track(new UnstakedRtd(properties), options);
  }

  /**
   * viewed ledger tutorial
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/viewed%20ledger%20tutorial)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/linkulabs/Rtd%20Wallet/events/main/latest/visited%20fiat%20on-ramp)
   *
