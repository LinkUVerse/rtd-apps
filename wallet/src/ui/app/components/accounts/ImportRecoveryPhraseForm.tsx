	...
	return (
		...
		>
			<div className="grid grid-cols-2 gap-x-2 gap-y-2.5">
				{recoveryPhrase.map((_: any, index: number) => {
			...
			<div className="flex flex-col gap-2.5 pt-3 bg-rtd-lightest sticky -bottom-7.5 px-6 pb-7.5 -mx-6 -mb-7.5">
				{touchedFields.recoveryPhrase && errors.recoveryPhrase && (
					<Alert>{errors.recoveryPhrase.message as string}</Alert>
				)}
