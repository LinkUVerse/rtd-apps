	...
	(
		...
		return (
			<div
				ref={ref}
				className={cn(
					'account-card-item flex flex-col px-4 py-3 rounded-xl gap-3 border border-solid cursor-pointer group',
					{ 'account-card-item--selected cursor-auto': selected },
					{ 'account-card-item--active': isActiveAccount },
					{ 'account-card-item--disabled border-none shadow-none': disabled },
					{
