...
export function CardLayout({
	...
	return (
		<div className="onboarding-surface flex flex-col flex-nowrap rounded-[10px] items-center p-6 pt-8 flex-grow w-full max-h-popup-height max-w-popup-width overflow-auto">
			{icon === 'success' ? (
