...
import { type PublicKey } from 'rtd-typescript/cryptography';
...
const saltRegistryUrl = 'https://salt.api.linkuverse.com';
...
const zkLoginProofsServerUrlDev = 'https://prover-dev.linkuverse.com/v1';
const zkLoginProofsServerUrlProd = 'https://prover.linkuverse.com/v1';
